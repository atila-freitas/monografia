...
class Aperfeicoamento extends Model
{
    ...
    protected $fillable = [
        ...
        'codigo_curso', 'nome_curso', 'nome_curso_ingles', 'codigo_area_curso', 'status_curso',
        'ano_inicio', 'ano_conclusao', 'flag_bolsa', 'codigo_agencia', 'nome_agencia', 'carga_horaria'
    ];

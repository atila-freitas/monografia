...
@section('content')
    ...
    <h1>Indicadores Gerais - {{$sigla}} </h1>
    <h2>{{$nome}}</h2>
    ...
    <section class="content box box-default">
        ...
        @section('js')
            <script>
                ...
                $.post(url + 'getArtigosPubPorAnoCentro/{{$id}}', function(data) {
                ...
                $.post(url + 'getQuantCapLivrosCentro/{{$id}}', function(data) {
                ...
                $.post(url + 'getQuantEventosCentro/{{$id}}', function(data) {
                ...
                // atualizaQualisCentro

                // $.post(url + 'atualizaQualisCentro', { ano1: strAno, id: strId }, function(data) {
                //
                ...
                $.post(url + 'qualisPorAnoCentro/{{$id}}', function(data) {
                ...
                $("#buscar").click(function() {
                    ...
                    $.post(url + 'atualizaQualisCentro', { ano: strAno, id: strId }, function(data)  {
                        ...
                        datasets : [
                            {
                                ...
                                borderWidth: 0,
                                data: [{{$numDeProfessores}}, 500 - ({{$numDeProfessores}})]
                            }
                        ]
                    },

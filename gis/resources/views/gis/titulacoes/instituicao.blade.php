...
@section('content')
    ...
    <div class="center">
        <h3 style="margin: 0 0 15px 0;">{{ $instituicao }}</h3>
    </div>

    @if (empty($dados))
        <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-3" style="margin-top: 20px;">
            <div class="alert alert-warning">
                <h4 style="@if (empty($submensagem)) margin: 0; @endif "><i class="icon fa fa-warning"></i> Nenhum dado encontrado dessa instituição</h4>
            </div>
        </div>
    @else
...
@section('js')
    <script>
        ...
        var instituicao = "<?php echo $instituicao; ?>";
        ...
        $.post(url + 'instituicao', { instituicao: instituicao }, function(data) {
